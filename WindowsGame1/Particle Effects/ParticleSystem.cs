...
namespace Synthesis
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        public void AddParticles(Vector2 where, Vector2 direction, Vector2 shipPosition, float rotationShip, bool random)
        {
            // the number of particles we want for this effect is a random number
            // somewhere between the two constants specified by the subclasses.
            int numParticles =
                Synthesis.Game1.Random.Next(minNumParticles, maxNumParticles);
            ...
            for (int i = 0; i < numParticles && freeParticles.Count > 0; i++)
            {
                ...
                InitializeParticle(p, where, direction, shipPosition, rotationShip, random);               
            }
        }
        ...
        {
            float angle = Synthesis.Game1.RandomBetween(0, MathHelper.TwoPi);
        ...
        /// </summary>
        public void DrawParticle(GameTime gameTime, Vector2 offset)
        {
