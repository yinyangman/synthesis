...
namespace Synthesis
{
    ...
    /// </summary>
    public class FusionParticleSystem : ParticleSystem
    {
        public FusionParticleSystem(Synthesis.Game1 game, int howManyEffects)
        ...
        protected override Vector2 PickRandomDirection()
        {
            ...
            float radians = Synthesis.Game1.RandomBetween(
        ...
        //protected override void InitializeParticle(Particles p, Vector2 where, Vector2 direction, Vector2 shipPosition, float rotationShip)
        //{
        //    //base.InitializeParticle(p, where, direction, shipPosition, rotationShip);
